...
export default function RazorpayCheckoutGateway(props: RazorpayGatewayProps) {
    const { amount, orderId, name, email, contact, onSuccess, onClose, onError } = props;
        ...
        if (Platform.OS === 'web') {
            ...
            loadScript().then((res) => {
                ...
                rzp.on('payment.failed', function (response: any) {
                    if (onError && response.error) onError(response.error.description || 'Payment Failed');
                });
                rzp.open();
            });
        }
